...
def extract():
    ...
    r = requests.get("https://docs.google.com/spreadsheets/d/e/2PACX-1vTDjitOlmILea7koCORJkq6QrUcwBJM7K3vy4guXB0mU_nWR6wsPn136bpH6ykoUxyYMW7wTwkzE371/pub?output=csv")
    r.encoding = "utf-8"
    data = r.text
    with open(r"C:\Users\cryst\Downloads\addresses.csv", "w") as output_file:
        output_file.write(data)

def transform():
    print("Add City, State")

    transformed_file = open(r"C:\Users\cryst\Downloads\new_addresses.csv", "w")
...
def load():
    ...
    arcpy.env.workspace = r"C:\Users\cryst\gis_programming\lab1\WestNileOutbreak.gdb\\"
    arcpy.env.overwriteOutput = True

    # Set the local variables
    in_table = r"C:\Users\cryst\Downloads\new_addresses.csv"
